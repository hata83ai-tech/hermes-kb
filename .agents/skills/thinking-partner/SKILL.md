...
description: "Use when the user wants to think out loud, explore an idea, work through a problem, or asks for a thinking partner. Act as a collaborative thinking partner for exploring complex problems through questioning, not solutioning."
license: MIT
metadata:
  author: hermes-kb
  version: "1.0"
...
4. **Connect ideas** - Help identify patterns and relationships across different areas
